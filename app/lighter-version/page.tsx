  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-b from-white to-indigo-50">
      ...
      <SpeakerCard
        ...
        description="A creative strategist at the intersection of design, video, and AI. Muneeb leads creative production at Brand Republic â€” building workflows that merge visual craft with intelligent automation to help brands tell better stories, faster."
        imageUrl="munneb.svg"
        badge="SPEAKER"
        speakerType="Speaker"
      />
      ...
      <WorkshopAgenda
        ...
        items={[
          { number: "01", title: "SETTING THE STAGE", description: "AI-narrated welcome â€¢ live warm-up exercise with a generated creative brief" },
          { number: "02", title: "MODERN CREATIVE REALITY", description: "The creator economy shift â€” why design + video + AI is now one skill" },
          ...
          { number: "04", title: "CORE DESIGN PRINCIPLES", description: "Hierarchy, spacing, contrast â€” applied live with AI-generated examples" },
          { number: "05", title: "SOCIAL MEDIA CAMPAIGN DESIGN", description: "One brief â†’ posts, stories, reels â†’ adapted per platform with AI tools" },
          { number: "06", title: "VIDEO PRODUCTION & MOTION", description: "Text-to-video with Higgsfield â€¢ live AI editing session" },
          { number: "07", title: "AI IN CREATIVE WORKFLOWS", description: "Full pipeline demo: concept â†’ design â†’ video â†’ caption, live" },
          { number: "08", title: "LIVE BUILD", description: "Audience gives a prompt â€” Muneeb builds a finished piece on screen in real time" },
